...
import (
	...
	synccontrollers "open-cluster-management.io/governance-policy-rbac-sync/controllers"
...
func main() {
	...
	options := manager.Options{
		...
		LeaderElectionID:   "governance-policy-rbac-sync.open-cluster-management.io",
	}
